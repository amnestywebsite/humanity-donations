...
To find issues that have yet to be acknowledged, you can use [this filter](https://github.com/amnestywebsite/humanity-donations/issues?q=is%3Aissue+is%3Aopen+comments%3A0+).  
...
To find discussions that have yet to be acknowledged, you can use [this filter](https://github.com/amnestywebsite/humanity-donations/discussions?discussions_q=is%3Aopen+comments%3A0).  
